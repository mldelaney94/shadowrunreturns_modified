...
ELP = 'materials\\translations\\en_deadmanswitch.pot'
...
def add_pinyin_to_chinese_strings():
    ...
    g = open("zh_deadmanswitch_with_pinyin.po", "w")
    with open('materials\\translations\\zh_deadmanswitch_no_pinyin.po', 'r') as f:
...
def format_fsentence(formatted_sent):
    ...
    replace_dict = {
            ...
            "{ { G M }": "{{GM}}",
            "S i l a s": "Silas",
            "A e g i s": "Aegis", ". . .": "...", "N T S B": "NTSB",
            "E c c h e r": "Eccher", "A z t e c h n o l o g y":
            "Aztecnology", "R u n n e r": "Runner", "B r u n o": "Bruno",
            "C o y o t e": "Coyote", "L o n e   S t a r": "Lone Star",
            " I D ": " ID ", "V a n   G r a a s": "Van Graas",
            "J a m e s": "James", "L A N": "LAN", "L o f w y r": "Lofwyr",
            "Y a k u z a": "Yakuza", "H a r k e e m": "Harkeem",
            "D N A": "DNA", "M c K l u s k y": "McKlusky",
            "T i r   T a i r n g i r e": "Tir Tairngire",
            "P i t e z e l": "Pitezel", "I n n e r   S a n c t u m": "Inner Sanctum",
            "T í r   n a n Ó g": "Tír na nÓg", "P D A": "PDA",
            "R e n r a k u": "Renraku", "E S P": "ESP", "G i n o": "Gino",
            "P i k e": "Pike",
    }
    ...
    for key in replace_dict:
        if key in formatted_sent:
            formatted_sent = formatted_sent.replace(key, replace_dict[key])
...
def make_comments_human_readable():
    ...
    ELP with that description. This should not really be used anymore, I'm
